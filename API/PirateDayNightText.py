...
def calculate_period_summary_text(
    ...
    if condition_type == "precip" or condition_type == "cloud":
        ...
        # Humidity-based combinations removed
        ...
        # Rest of wind combinations (dry/humid removed)
...
def calculate_half_day_text(
    ...
    if has_precip:
        # Pass relevant period lists to allow calculate_period_summary_text to determine internal combinations
    ...
    # Dry/humid specific summaries removed
    ...
    # Dry/humid summary options removed; cloud is used as fallback
