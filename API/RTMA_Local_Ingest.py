...
# It accounts for the roughly one-hour delay in RTMA data availability.
...
def main():
    """
    Main function to orchestrate the RTMA data ingestion for a historical period.
    """
    ...
    for date in dates:
        ...
        try:
            ...
            store_path = f"{historic_path}/{ingestVersion}/RTMA.zarr"
            if saveType == "S3":
