...
def get_latest_rtma_ru_data():
    ...
    try:
        ...
        # Open the GRIB2 file using pygrib or a similar library to inspect
        ...
        print(f"Failed to download or process RTMA-RU data: {e}")
        traceback.print_exc()
        raise
...
def main():
    ...
    try:
        ...
        print(f"Failed to download RTMA-RU data: {e}")
        traceback.print_exc()
        sys.exit(1)
    ...
    try:
        ...
        print(f"RTMA-RU data successfully processed for {base_time}")

    except Exception as e:
        print(f"Failed to save RTMA-RU data: {e}")
        traceback.print_exc()
        sys.exit(1)